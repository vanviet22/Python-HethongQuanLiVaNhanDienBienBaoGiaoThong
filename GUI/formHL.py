...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.widgetTieuDe.setStyleSheet("background-color: #D3D3D3;")
        self.lb_AnhTD = QtWidgets.QLabel(self.widgetTieuDe)
        self.lb_AnhTD.setGeometry(QtCore.QRect(0, 0, 201, 121))
        ...
        self.label.setGeometry(QtCore.QRect(360, 20, 331, 51))
        font = QtGui.QFont()
        ...
        self.label.setStyleSheet("QLabel#label { color: #4c7b8b; }")
        ...
        self.lb_YNghia.setGeometry(QtCore.QRect(150, 210, 81, 35))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.txYNghia.setGeometry(QtCore.QRect(240, 210, 481, 31))
        ...
        self.tableBienChiDan.horizontalHeader().setDefaultSectionSize(293)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Quản lí biển báo hiệu lệnh"))
    ...
    def hienThi(self):
        try:
            ...
            query = "SELECT * FROM bienbaohieulenh"
            cursor = conn.cursor()
    ...
    def them(self):
        if(self.textEdit.toPlainText()==""):
            ...
            try:
                conn=mysql.connector.connect(user='root', password='123456789', host='localhost', database='doan_py')
                cursor = conn.cursor()
                sql="INSERT INTO bienbaohieulenh(Ten_BienBaoHieuLenh,Mieuta,HinhAnhBBHL) VALUES (%s,%s,%s)"
    ...
    def sua(self):
        ...
        if (selected_row >= 0 and selected_row < len(self.dsBB)):
            ...
            if self.textEdit.toPlainText() == "":
                ...
                imgpath=self.dsBB[selected_row].get_imgPath()
                if(self.imgPath!=""):
                ...
                try:
                    conn = mysql.connector.connect(user='root', password='123456789', host='localhost',database='doan_py')
                    cursor = conn.cursor()
                    sql="UPDATE bienbaohieulenh SET Ten_BienBaoHieuLenh= %s , Mieuta= %s , HinhAnhBBHL= %s WHERE Ten_BienBaoHieuLenh= %s"
    ...
    def xoa(self):
         ...
         if (selected_row >= 0 and selected_row < len(self.dsBB)):
            ...
            try:
                conn = mysql.connector.connect(user='root', password='123456789', host='localhost', database='doan_py')
                cursor = conn.cursor()
                sql="DELETE FROM bienbaohieulenh WHERE Ten_BienBaoHieuLenh = %s"
